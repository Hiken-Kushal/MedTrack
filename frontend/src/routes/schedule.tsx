            ...
            {schedules.map((day) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex flex-col items-center justify-center rounded-2xl p-2.5 sm:p-3 text-center transition-all relative",
                    isSelected
                ...
                >
                  ...
                  <span className="mt-1 text-base sm:text-lg font-bold tabular leading-tight">
                    {day.dayNum}
                  </span>
                  <span
                    className={cn(
