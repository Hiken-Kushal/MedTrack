        ...
        <div className="space-y-2.5">
          ...
          <div className="flex items-center justify-between gap-3 rounded-2xl border border-border bg-card p-3.5 transition-all hover:border-border-strong">
            ...
            <Button
              ...
              className="rounded-xl border-border text-xs font-semibold h-8"
            >
              Change Password
            </Button>
          </div>
          ...
          <div className="flex items-center justify-between gap-3 rounded-2xl border border-border bg-card p-3.5">
            ...
            <span className="rounded-full border border-success/30 bg-success-soft px-2.5 py-0.5 text-[10px] font-bold text-success">
              Active
            </span>
          </div>
        </div>
